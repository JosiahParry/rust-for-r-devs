...
- parsing urls correctly is a touch thing to do!
...
- Or run `cargo check` from the terminal
- This is my preference, personally
...
- Access the inner type with `.inner()`
...
::: callout-note
Cloning an extendr `Robj` (or other wrapper type) is cheap. We only increment a _reference count_—**not** a full copy like we do in R.
:::
