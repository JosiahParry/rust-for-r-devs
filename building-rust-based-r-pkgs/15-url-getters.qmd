...
- Now that we can hold objects in a list, we can expose their methods to R. 
- The `Url` struct has many methods that we can access from R and our vctr

the approach to use these methods is frankly somewhat formulaic. 
since we have multiple of these structs in our vector the approach is simple: 

- iterate through the list
- gracefully g4et the external pointer
- call the method
